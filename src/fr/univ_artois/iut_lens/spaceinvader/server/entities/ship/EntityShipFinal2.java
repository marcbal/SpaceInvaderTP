...
public class EntityShipFinal2 extends EntityShip implements ShipLimitedShot {
	...
	public void shoot(long currentTime) {
			entitiesManager.add(new EntityShotFromAllyFinal2(new Vector2d(getPosition().x+getBoundingBox().width/2-5, getPosition().y), new Vector2d(0, -200), entitiesManager, this, duplicationInterval, nbOfChildPerDuplication));
	}
