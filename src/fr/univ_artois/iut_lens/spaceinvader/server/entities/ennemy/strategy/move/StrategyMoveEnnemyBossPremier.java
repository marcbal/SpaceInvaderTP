	...
	public void performMove(long delta, EntitiesManager entMan) {
		...
		for(Entity entity : entMan.getEntityListSnapshot()) {
	    	if (entity instanceof EntityEnnemy){
	    		...
	    		else if (leftRight == 'r' && (entity.getPosition().x > MegaSpaceInvader.DISPLAY_WIDTH - entity.getBoundingBox().width))
	    			leftRight= 'l';
	    		...
	    		if(upDown == 'd' && (entity.getPosition().y > MegaSpaceInvader.DISPLAY_HEIGHT - entity.getBoundingBox().height - 120))
	    			upDown = 'u';
