	...
	public void performMove(long delta, EntitiesManager entMan) {
		...
		for(Entity entity : entMan.getEntitiesList()) {
	    	if (entity instanceof EntityEnnemy){
	    		...
	    		else if (leftRight == 'r' && (entity.getPosition().x > Game.gameInstance.getWindowWidth() - entity.getBoundingBox().width))
	    			leftRight= 'l';
	    		...
	    		if(upDown == 'd' && (entity.getPosition().y > Game.gameInstance.getWindowHeight() - entity.getBoundingBox().height - 120))
	    			upDown = 'u';
