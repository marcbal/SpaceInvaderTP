...
public class KeyInputHandler extends KeyAdapter {
	...
	public boolean isKeyPressed(String action) {
		...
		System.err.println("La configuration de touche \""+action+"\" n'existe pas dans KeyInputHandler.keyState");
		return false;
	}
	public boolean isKeyToggle(String action) {
		if (keyToggle.containsKey(action))
			return keyToggle.get(action).state==1;
		System.err.println("La configuration de touche \""+action+"\" n'existe pas dans KeyInputHandler.keyToggle");
		return false;
	}
	public boolean isKeyWaitPress(String action) {
		...
		System.err.println("La configuration de touche \""+action+"\" n'existe pas dans KeyInputHandler.keyWaitPress");
		return false;
	}
